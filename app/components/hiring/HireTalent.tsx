            ...
            <div className="w-full max-w-5xl px-2 md:px-0 relative">
                ...
                >
                    {slides.map((slide, idx) => (
                        <SwiperSlide key={idx}>
                            <div className="bg-[#ededed] rounded-3xl flex flex-row items-center p-8 gap-8 min-h-[220px] shadow-md relative">
                ...
                <div className="absolute flex items-center gap-4 md:right-0 left-1/2 -bottom-16 z-10 border border-red-500">
                    <button className="swiper-prev w-12 h-12 rounded-full border-2 border-pink-300 flex items-center justify-center text-pink-400 hover:bg-pink-50 transition shadow-md ml-2">
                        <ArrowLeft className="w-7 h-7" />
                    </button>
                    <button className="swiper-next w-12 h-12 rounded-full border-2 border-pink-300 flex items-center justify-center text-pink-400 hover:bg-pink-50 transition shadow-md">
