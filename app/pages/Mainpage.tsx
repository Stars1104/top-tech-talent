const MainPage = () => {
    return (
        <div className="w-full min-h-[1087px] flex bg-no-repeat bg-[95%_center] lg:bg-center bg-cover relative justify-center md:items-center items-start px-2 sm:px-4" style={{ backgroundImage: "url('/images/background.png')" }}>
            ...
            {/* Left Side Content */}
            <div className="w-full max-w-[1600px] px-2 sm:px-4 md:mt-0 mt-52">
                <div className="relative z-10 flex flex-col justify-center items-start h-full w-full max-w-full xl:max-w-[70%] text-white">
